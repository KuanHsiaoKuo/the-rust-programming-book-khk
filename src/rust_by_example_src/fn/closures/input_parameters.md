...
annotation, this ambiguity is not allowed when writing functions. 
...
~~~admonish info title="In the following example, try swapping the usage of *Fn*, *FnMut*, and *FnOnce* to see what happens:" collapsible=true
```rust,editable
