...
<!-- Added by: runner, at: Tue Dec 27 14:23:36 UTC 2022 -->
...
- then the `dyn`
  ...
  Sized Types and the `Sized` Trait.”][dynamically-sized]<!-- ignore -->)
...
> However, we did get extra flexibility in the code that we wrote in Listing 17-5 and were able to
